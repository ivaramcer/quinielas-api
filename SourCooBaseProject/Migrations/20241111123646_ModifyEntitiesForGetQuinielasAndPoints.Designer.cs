...
namespace QuinielasApi.Migrations
{
    ...
    [Migration("20241111123646_ModifyEntitiesForGetQuinielasAndPoints")]
    partial class ModifyEntitiesForGetQuinielasAndPoints
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("QuinielasApi.Models.Entities.Quiniela", b =>
                {
                    ...
                    b.Property<int>("QuotaPeopleFilled")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("QuinielasApi.Models.Entities.Status", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            Description = "Selected people has access!",
                            Name = "Private"
                        });
                });
            ...
            modelBuilder.Entity("QuinielasApi.Models.Entities.Wallet", b =>
                {
                    b.HasOne("QuinielasApi.Models.Entities.User", "User")
                        .WithOne("Wallet")
                        .HasForeignKey("QuinielasApi.Models.Entities.Wallet", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
